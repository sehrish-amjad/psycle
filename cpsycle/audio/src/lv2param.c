...
static void lv2pluginparam_tweak(psy_audio_LV2Param*, double val);
static int lv2pluginparam_describe(psy_audio_LV2Param*, char* text);
static double lv2pluginparam_norm_value(psy_audio_LV2Param*);
...
void lv2pluginparam_tweak(psy_audio_LV2Param* self, double value)
{	
	float range;
...
double lv2pluginparam_norm_value(psy_audio_LV2Param* self)
{
	double range;
