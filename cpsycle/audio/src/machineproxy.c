...
static intptr_t machineproxy_mode(const psy_audio_MachineProxy*);
...
static psy_audio_MachineParam* machineproxy_tweakparameter(psy_audio_MachineProxy*,
	uintptr_t param);
static void machineproxy_setpanning(psy_audio_MachineProxy*, double);
static double machineproxy_panning(const psy_audio_MachineProxy*);
...
static void machineproxy_postload(psy_audio_MachineProxy*, psy_audio_SongFile*,
	uintptr_t slot);
static double machineproxy_samplerate(psy_audio_MachineProxy*);
static double machineproxy_bpm(psy_audio_MachineProxy*);
static psy_audio_SequencerTime* machineproxy_sequencertime(psy_audio_MachineProxy*);
static double machineproxy_beatspertick(psy_audio_MachineProxy*);
static double machineproxy_beatspersample(psy_audio_MachineProxy*);
static double machineproxy_currbeatsperline(psy_audio_MachineProxy*);
...
static uintptr_t machineproxy_numcaptures(const psy_audio_MachineProxy*);
...
static void machineproxy_param_tweak(psy_audio_MachineProxy*, psy_audio_MachineParam* param, double val);
static void machineproxy_param_reset(psy_audio_MachineProxy*, psy_audio_MachineParam* param);
static double machineproxy_param_normvalue(psy_audio_MachineProxy*, psy_audio_MachineParam* param);
static void machineproxy_param_range(psy_audio_MachineProxy*, psy_audio_MachineParam* param, intptr_t* minval, intptr_t* maxval);
static int machineproxy_param_type(psy_audio_MachineProxy*, psy_audio_MachineParam* param);
static int machineproxy_param_label(psy_audio_MachineProxy*, psy_audio_MachineParam* param, char* text);
static int machineproxy_param_name(psy_audio_MachineProxy*, psy_audio_MachineParam* param, char* text);
static int machineproxy_param_describe(psy_audio_MachineProxy*, psy_audio_MachineParam* param, char* text);
// data
...
static void vtable_init(psy_audio_MachineProxy* self)
{
	if (!vtable_initialized) {
		...
		vtable.set_curr_program = (fp_machine_setcurrprogram)machineproxy_setcurrprogram;
...
#endif		
		{
			psy_audio_machine_generate_audio(self->client, bc);
			if (self->client->err) {
				self->crashed = 1;
#if defined DIVERSALIS__OS__MICROSOFT                 
...
#endif		
		{
			psy_audio_machine_seq_tick(self->client, channel, event);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_sequencer_tick(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
intptr_t machineproxy_mode(const psy_audio_MachineProxy* self)
{
	intptr_t rv = 0;
...
#if defined DIVERSALIS__OS__MICROSOFT		
		__except(FilterException(((psy_audio_MachineProxy*)self), "mode", GetExceptionCode(),
			GetExceptionInformation())) {			
		}
#endif		
	}
...
#endif		
		{
			rv = psy_audio_machine_module_path(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_shell_index(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_inputs(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_outputs(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_tweak_parameter(self->client, param);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
void machineproxy_setpanning(psy_audio_MachineProxy* self, double panning)
{	
	if (self->crashed == 0) {
#if defined DIVERSALIS__OS__MICROSOFT        
		__try
#endif		
		{
			psy_audio_machine_set_panning(self->client, panning);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
double machineproxy_panning(const psy_audio_MachineProxy* self)
{
	double rv = 0.0;
...
#if defined DIVERSALIS__OS__MICROSOFT		
		__except(FilterException((psy_audio_MachineProxy*)self, "panning", GetExceptionCode(),
			GetExceptionInformation())) {			
		}
#endif		
	}
...
#endif		
		{
			psy_audio_machine_set_bus(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_param_strobe(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_parameters(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_tweak_parameters(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_param_selected(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_select_param(self->client, index);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_parameter_cols(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_load_specific(self->client, songfile, slot);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_load_wire_mapping(self->client, songfile, slot);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_save_specific(self->client, songfile, slot);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
		__except(FilterException(self,"loadspecific",  GetExceptionCode(),
			GetExceptionInformation())) {
...
#endif		
		{
			rv = psy_audio_machine_save_wire_mapping(self->client, songfile, slot);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_post_load(self->client, songfile, slot);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
		__except (FilterException(self, "loadspecific", GetExceptionCode(),
			GetExceptionInformation())) {
...
double machineproxy_samplerate(psy_audio_MachineProxy* self)
{
	double rv = 0;
...
double machineproxy_bpm(psy_audio_MachineProxy* self)
{
	double rv = 0;
...
#endif		
		{
			rv = psy_audio_machine_sequencer_time(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
double machineproxy_beatspertick(psy_audio_MachineProxy* self)
{
	double rv = 0;
...
double machineproxy_beatspersample(psy_audio_MachineProxy* self)
{
	double rv = 0;
...
#endif		
		{
			rv = psy_audio_machine_beats_per_sample(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
double machineproxy_currbeatsperline(psy_audio_MachineProxy* self)
{
	double rv = 0;
...
#endif		
		{
			rv = psy_audio_machine_curr_beats_per_line(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
	{
		rv = psy_audio_machine_edit_resize(self->client, w, h);
	}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
	{
		psy_audio_machine_bus_changed(self->client);
	}
#if defined DIVERSALIS__OS__MICROSOFT		
...
{ 
	if (self->crashed == 0) {
		...
		{ 
			...
			psy_audio_machine_set_callback(self->client, callback);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{ 
			rv = psy_audio_machine_has_editor(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{ 
			psy_audio_machine_set_editor_handle(self->client, handle);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_set_edit_name(self->client, name);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_buffermemory_size(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_set_buffermemory_size(self->client, size);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_amp_range(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_sequencer_insert(self->client, events);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_put_data(self->client, data);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_data_size(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_program_name(self->client, bnkidx, prgIdx, val);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_programs(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_bank_name(self->client, bnkidx, val);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_banks(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_set_curr_program(self->client, prgidx);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
		__except (FilterException(self, "programname",
			GetExceptionCode(), GetExceptionInformation())) {
...
#endif		
		{
			rv = psy_audio_machine_curr_program(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_set_curr_bank(self->client, prgidx);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
		__except (FilterException(self, "bankname",
			GetExceptionCode(), GetExceptionInformation())) {
...
#endif		
		{
			rv = psy_audio_machine_curr_bank(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_current_preset(self->client, preset);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_tweak_preset(self->client, preset);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_set_presets(self->client, presets);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			return psy_audio_machine_accept_presets(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_capture_name(self->client, index);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
uintptr_t machineproxy_numcaptures(const psy_audio_MachineProxy* self)
{
	uintptr_t rv = 0;
...
#endif		
		{
			rv = psy_audio_machine_num_captures(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
		__except (FilterException((psy_audio_MachineProxy*)self, "numcaptures", GetExceptionCode(),
			GetExceptionInformation())) {
		}
#endif		
	}
...
#endif		
		{
			rv = psy_audio_machine_playback_name(self->client, index);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_playbacks(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
void machineproxy_param_tweak(psy_audio_MachineProxy* self, psy_audio_MachineParam* param, double val)
{	
	if (self->crashed == 0) {
#if defined DIVERSALIS__OS__MICROSOFT        
		__try
...
double machineproxy_param_normvalue(psy_audio_MachineProxy* self, psy_audio_MachineParam* param)
{
	double rv = 0.0;
...
#endif		
		{
			rv = psy_audio_machine_parameter_norm_value(self->client, param);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_aux_column_name(self->client, index);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_num_aux_columns(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			rv = psy_audio_machine_aux_column_selected(self->client);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
...
#endif		
		{
			psy_audio_machine_select_aux_column(self->client, index);
		}
#if defined DIVERSALIS__OS__MICROSOFT		
