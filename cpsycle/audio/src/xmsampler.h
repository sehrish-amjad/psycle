...
** @brief JosepMa's MOD, XM and IT Internal Psycle Sampler
**
** @details
** It is one of the two Psycle internal machines that are able to play sampled
** sounds.
** Sampulse is the more powerful of both, and tries to be as feature packed and
** compatible with the engines in classic trackers like Fasttracker and
** Impulse Tracker.
** Partially based on Satoshi Fujiwara 'XMSampler', IT Filtering from OpenMPT
*/
