...
void psy_audio_activechannels_set_machines(psy_audio_ActiveChannels*,
	struct psy_audio_Machines* machines);
void psy_audio_activechannels_write(psy_audio_ActiveChannels*,
	uintptr_t channel, struct psy_audio_PatternEvent*);
bool psy_audio_activechannels_play_on(const psy_audio_ActiveChannels*,
	uintptr_t channel);
