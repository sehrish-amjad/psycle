...
void psy_audio_preset_set_name(psy_audio_Preset*, const char* name);
const char* psy_audio_preset_name(psy_audio_Preset*);
void psy_audio_preset_set_value(psy_audio_Preset*, uintptr_t param,
	intptr_t value);
intptr_t psy_audio_preset_value(psy_audio_Preset*, uintptr_t param);
void psy_audio_preset_set_data_struct(psy_audio_Preset*,
    uintptr_t num, const char* newname, int const* parameters, uintptr_t size,
	void* newdata);
void psy_audio_preset_put_data(psy_audio_Preset*, uintptr_t size,
	void* newdata);

INLINE uintptr_t psy_audio_preset_num_parameters(psy_audio_Preset* self)
{
