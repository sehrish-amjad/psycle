...
/*!
** @struct psy_audio_PSY2Loader
** @brief Load filter for psy2 songs and instruments.
**
** @details
** This format is used in older psycle versions, where many songs were written
** in.
...
typedef struct PSY2Loader {
	...
	struct psy_audio_Machine* pMac[128];
