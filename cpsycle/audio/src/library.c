...
bool psy_library_empty(const psy_Library* self)
{
...
void psy_library_set_env(psy_Library* self, const char* path, const char* root)
{
#if defined(DIVERSALIS__OS__MICROSOFT)
	char* temp;
	const char* p;
...
void psy_library_restore_env(psy_Library* self)
{
#if defined(DIVERSALIS__OS__MICROSOFT)
