...
/*!
** \interface psy_audio_Machine
** \brief Abstract base class for "Machines", the audio producing elements
*/
...
typedef double (*fp_mcb_samplerate)(void*);
typedef	struct psy_audio_SequencerTime* (*fp_mcb_sequencertime)(void*);
typedef	double (*fp_mcb_bpm)(void*);
typedef	double (*fp_mcb_beatspertick)(void*);
typedef	double (*fp_mcb_beatspersample)(void*);
typedef	double (*fp_mcb_currbeatsperline)(void*);
...
typedef uintptr_t (*fp_mcb_numcaptures)(const void*);
...
typedef void (*fp_mcb_message)(void*, const char*);
typedef void (*fp_mcb_custom_setup)(void*, int, void*);
...
typedef struct {
	...
	fp_mcb_message message;
        fp_mcb_custom_setup custom_setup;
...
typedef	void (*fp_machine_setpanning)(struct psy_audio_Machine*,
	double);
typedef	double (*fp_machine_panning)(const struct psy_audio_Machine*);
...
typedef	const psy_audio_MachineInfo* (*fp_machine_info)(const struct
	psy_audio_Machine*);
typedef	intptr_t (*fp_machine_mode)(const struct psy_audio_Machine*);
...
typedef	void (*fp_machine_param_tweak)(struct psy_audio_Machine*, struct
	psy_audio_MachineParam*, double val);
typedef	void (*fp_machine_param_reset)(struct psy_audio_Machine*, struct
	psy_audio_MachineParam*);
typedef double (*fp_machine_param_normvalue)(struct psy_audio_Machine*, struct
	psy_audio_MachineParam*);
...
/* machine callbacks */
typedef	double (*fp_machine_samplerate)(struct psy_audio_Machine*);
typedef double (*fp_machine_bpm)(struct psy_audio_Machine*);
typedef struct psy_audio_SequencerTime* (*fp_machine_sequencertime)(struct psy_audio_Machine*);
typedef double (*fp_machine_beatspertick)(struct psy_audio_Machine*);
typedef double (*fp_machine_beatspersample)(struct psy_audio_Machine*);
typedef double(*fp_machine_currbeatsperline)(struct
	psy_audio_Machine*);
...
typedef const char* (*fp_machine_capturename)(struct psy_audio_Machine*,
	int index);
typedef uintptr_t (*fp_machine_numcaptures)(const struct psy_audio_Machine*);
...
typedef struct {
	...
	/* programs */
	fp_machine_setcurrprogram set_curr_program;
...
INLINE void psy_audio_machine_set_callback(psy_audio_Machine* self,
	psy_audio_MachineCallback* callback)
{
...
INLINE void psy_audio_machine_generate_audio(psy_audio_Machine* self,
	psy_audio_BufferContext* bc)
{
	self->vtable->generateaudio(self, bc);
}

INLINE intptr_t psy_audio_machine_type(const psy_audio_Machine* self)
{	
...
INLINE void psy_audio_machine_sequencer_tick(psy_audio_Machine* self)
{
...
INLINE void psy_audio_machine_seq_tick(psy_audio_Machine* self, uintptr_t
...
INLINE psy_List* psy_audio_machine_sequencer_insert(psy_audio_Machine* self,
	psy_List* events)
{
	return self->vtable->sequencerinsert(self, events);
}

INLINE int psy_audio_machine_load_specific(psy_audio_Machine* self,
	struct psy_audio_SongFile* songfile, uintptr_t slot)
{
	return self->vtable->loadspecific(self, songfile, slot);
}

INLINE int psy_audio_machine_load_wire_mapping(psy_audio_Machine* self,
	struct psy_audio_SongFile* songfile, uintptr_t slot)
{
	return self->vtable->loadwiremapping(self, songfile, slot);
}

INLINE int psy_audio_machine_save_specific(psy_audio_Machine* self,
	struct psy_audio_SongFile* songfile, uintptr_t slot)
{
	return self->vtable->savespecific(self, songfile, slot);
}

INLINE int psy_audio_machine_save_wire_mapping(psy_audio_Machine* self,
	struct psy_audio_SongFile* songfile, uintptr_t slot)
{
	return self->vtable->savewiremapping(self, songfile, slot);
}

INLINE void psy_audio_machine_post_load(psy_audio_Machine* self,
	struct psy_audio_SongFile* songfile, uintptr_t slot)
{
...
INLINE uintptr_t psy_audio_machine_num_inputs(psy_audio_Machine* self)
{
	return self->vtable->numinputs(self);
}

INLINE uintptr_t psy_audio_machine_num_outputs(psy_audio_Machine* self)
{
...
INLINE void psy_audio_machine_set_slot(psy_audio_Machine* self, uintptr_t slot)
{
	self->vtable->setslot(self, slot);
}

INLINE void psy_audio_machine_set_panning(psy_audio_Machine* self, double pan)
{
	self->vtable->setpanning(self, pan);
}

INLINE double psy_audio_machine_panning(psy_audio_Machine* self)
{
	return self->vtable->panning(self);
}

INLINE const psy_audio_MachineInfo* psy_audio_machine_info(const psy_audio_Machine*
	self)
{
	return self->vtable->info(self);
}

INLINE void psy_audio_machine_set_edit_name(psy_audio_Machine* self, const char*
	name)
{
	self->vtable->seteditname(self, name);
}

INLINE const char* psy_audio_machine_edit_name(psy_audio_Machine* self)
{
	return self->vtable->editname(self);
}

INLINE intptr_t psy_audio_machine_mode(const psy_audio_Machine* self)
{
	return self->vtable->mode(self);
}

INLINE const char* psy_audio_machine_module_path(psy_audio_Machine* self)
{
	return self->vtable->modulepath(self);
}

INLINE uintptr_t psy_audio_machine_shell_index(psy_audio_Machine* self)
{
...
INLINE uintptr_t psy_audio_machine_num_parameter_cols(psy_audio_Machine* self)
{
	return self->vtable->numparametercols(self);
}

INLINE uintptr_t psy_audio_machine_num_parameters(psy_audio_Machine* self)
{
	return self->vtable->numparameters(self);
}

INLINE psy_audio_MachineParam* psy_audio_machine_parameter(psy_audio_Machine*
	self, uintptr_t param)
{
	return self->vtable->parameter(self, param);
}

INLINE uintptr_t psy_audio_machine_num_tweak_parameters(psy_audio_Machine* self)
{
	return self->vtable->numtweakparameters(self);
}

INLINE psy_audio_MachineParam* psy_audio_machine_tweak_parameter(
	psy_audio_Machine* self, uintptr_t param)
{
	return self->vtable->tweakparameter(self, param);
}

INLINE uintptr_t psy_audio_machine_param_selected(
	psy_audio_Machine* self)
{
	return self->vtable->paramselected(self);
}

INLINE void psy_audio_machine_select_param(psy_audio_Machine* self, uintptr_t index)
{
	self->vtable->selectparam(self, index);
}

INLINE uintptr_t psy_audio_machine_param_strobe(const psy_audio_Machine* self)	
{
...
INLINE void psy_audio_machine_parameter_tweak(psy_audio_Machine* self,
	psy_audio_MachineParam* param, double val)
{
...
INLINE double psy_audio_machine_parameter_norm_value(psy_audio_Machine* self,
	psy_audio_MachineParam* param)
{
	...
	psy_audio_MachineParam* param, intptr_t scaledvalue)
{
	...
	if (range == 0) {
		...
		value = (double)(scaledvalue - minval) / (double)range;
	}
	if (value > 1.0) {
		value = 1.0;
	}
	...
	psy_audio_MachineParam* param, uintptr_t patternvalue)
{
	...
	if (range == 0) {
		...
		value = (double)patternvalue / (double)range;
	}
	if (value > 1.0) {
		value = 1.0;
	}
...
/* converts norm value (0.0 .. 1.0)->scaled integer value */
INLINE intptr_t psy_audio_machine_parameter_scaled_value(psy_audio_Machine*
	self, psy_audio_MachineParam* param)
{
	...
	psy_audio_machine_parameter_range(self, param, &minval, &maxval);
	range = maxval - minval;
	rv = (intptr_t)(psy_audio_machine_parameter_norm_value(self, param) * range)
		+ minval;
	return rv;
}

/*
** converts normvalue(0.0 .. 1.0)->pattern integer value
** difference to scaledvalue: starting always at 0 (offseted by minvalue)
** returning the pattern tweak value
*/
INLINE intptr_t psy_audio_machine_parameter_pattern_value(psy_audio_Machine*
	self, psy_audio_MachineParam* param)
{
	intptr_t rv;
	intptr_t minval;
	...
	psy_audio_machine_parameter_range(self, param, &minval, &maxval);
	range = maxval - minval;
	rv = (intptr_t)(psy_audio_machine_parameter_norm_value(self, param) *
		range);
	return rv;
}

INLINE void psy_audio_machine_put_data(psy_audio_Machine* self, uint8_t* data)
{
...
INLINE  uintptr_t psy_audio_machine_data_size(psy_audio_Machine* self)
{
	return self->vtable->datasize(self);
}

INLINE psy_dsp_amp_range_t psy_audio_machine_amp_range(psy_audio_Machine* self)
{
	return self->vtable->amprange(self);
}

INLINE void psy_audio_machine_program_name(psy_audio_Machine* self, uintptr_t bnkidx,
	uintptr_t prgidx, char* val)
{
	self->vtable->programname(self, bnkidx, prgidx, val);
}

INLINE uintptr_t psy_audio_machine_num_programs(psy_audio_Machine* self)
{
	return self->vtable->numprograms(self);
}

INLINE void psy_audio_machine_set_curr_program(psy_audio_Machine* self,
	intptr_t prgidx)
{
	self->vtable->set_curr_program(self, prgidx);
}

INLINE intptr_t psy_audio_machine_curr_program(psy_audio_Machine* self)
{
	return self->vtable->currprogram(self);
}

INLINE void psy_audio_machine_bank_name(psy_audio_Machine* self, intptr_t bnkidx,
	char* val)
{
	self->vtable->bankname(self, bnkidx, val);
}

INLINE intptr_t psy_audio_machine_num_banks(psy_audio_Machine* self)
{
	return self->vtable->numbanks(self);
}

INLINE void psy_audio_machine_set_curr_bank(psy_audio_Machine* self, intptr_t prgidx)
{
	self->vtable->setcurrbank(self, prgidx);
}

INLINE intptr_t psy_audio_machine_curr_bank(psy_audio_Machine* self)
{
	return self->vtable->currbank(self);
}

INLINE void psy_audio_machine_current_preset(psy_audio_Machine* self,
	struct psy_audio_Preset* preset)
{
	self->vtable->currentpreset(self, preset);
}

INLINE void psy_audio_machine_tweak_preset(psy_audio_Machine* self,
	struct psy_audio_Preset* preset)
{
	self->vtable->tweakpreset(self, preset);
}

INLINE void psy_audio_machine_set_presets(psy_audio_Machine* self,
...
INLINE bool psy_audio_machine_accept_presets(psy_audio_Machine* self)
{
	return self->vtable->acceptpresets(self);
}

INLINE const char* psy_audio_machine_aux_column_name(psy_audio_Machine* self, uintptr_t index)
{
	return self->vtable->auxcolumnname(self, index);
}

INLINE uintptr_t psy_audio_machine_num_aux_columns(psy_audio_Machine* self)
{
	return self->vtable->numauxcolumns(self);
}

INLINE uintptr_t psy_audio_machine_aux_column_selected(psy_audio_Machine* self)
{
	return self->vtable->auxcolumnselected(self);
}

INLINE void psy_audio_machine_select_aux_column(psy_audio_Machine* self, uintptr_t index)
{
...
INLINE int psy_audio_machine_has_editor(psy_audio_Machine* self)
{
	return self->vtable->haseditor(self);
}

INLINE void psy_audio_machine_set_editor_handle(psy_audio_Machine* self, void*
	handle)
{
	self->vtable->seteditorhandle(self, handle);
}

INLINE void psy_audio_machine_editor_size(psy_audio_Machine* self, double* width,
	double* height)
{
	self->vtable->editorsize(self, width, height);
}

INLINE void psy_audio_machine_editor_idle(psy_audio_Machine* self)
{
	self->vtable->editoridle(self);
}

INLINE void psy_audio_machine_set_position(psy_audio_Machine* self, double x,
	double y)
{
	self->vtable->setposition(self, x, y);
}

INLINE void psy_audio_machine_position(psy_audio_Machine* self, double* rv_x,
	double* rv_y)
{
	self->vtable->position(self, rv_x, rv_y);
}

INLINE void psy_audio_machine_set_host_view(psy_audio_Machine* self,
	struct psy_ui_Component* view)
{
...
INLINE void psy_audio_machine_deactivate_standby(psy_audio_Machine* self)
{
	self->vtable->deactivatestandby(self);
}

INLINE int psy_audio_machine_has_standby(psy_audio_Machine* self)
{
	return self->vtable->hasstandby(self);
}
/* bus */
INLINE void psy_audio_machine_set_bus(psy_audio_Machine* self)
{
	self->vtable->setbus(self);
}

INLINE void psy_audio_machine_unset_bus(psy_audio_Machine* self)
{
	self->vtable->unsetbus(self);
}

INLINE int psy_audio_machine_is_bus(psy_audio_Machine* self)
{
...
INLINE uintptr_t psy_audio_machine_buffermemory_size(psy_audio_Machine* self)
{
	return self->vtable->buffermemorysize(self);
}

INLINE void psy_audio_machine_set_buffermemory_size(psy_audio_Machine* self,
	uintptr_t size)
{
	self->vtable->setbuffermemorysize(self, size);
}

INLINE void psy_audio_machine_reset_buffermemory(psy_audio_Machine* self)
{
	psy_audio_machine_set_buffermemory_size(self, psy_audio_MAX_STREAM_SIZE);
}

void psy_audio_machine_update_memory(psy_audio_Machine*,
	psy_audio_BufferContext* bc);


INLINE double psy_audio_machine_bpm(psy_audio_Machine* self)
{
	return self->vtable->bpm(self);
}

INLINE struct psy_audio_SequencerTime* psy_audio_machine_sequencer_time(psy_audio_Machine* self)	 
{
	return self->vtable->sequencertime(self);
}

INLINE double psy_audio_machine_beatspertick(psy_audio_Machine* self)
{
	return self->vtable->beatspertick(self);
}

INLINE double psy_audio_machine_samples_per_tick(psy_audio_Machine* self)
{
	return 1.f / self->vtable->beatspersample(self) *
		self->vtable->beatspertick(self);
}

INLINE uintptr_t psy_audio_machine_ticks_per_beat(psy_audio_Machine* self)
{
	return (uintptr_t)(1 / self->vtable->beatspertick(self));
}

INLINE double psy_audio_machine_beats_per_sample(psy_audio_Machine* self)
{
	return self->vtable->beatspersample(self);
}

INLINE double psy_audio_machine_curr_beats_per_line(psy_audio_Machine*
	self)
{
	return self->vtable->currbeatsperline(self);
}

INLINE uintptr_t psy_audio_machine_curr_samples_per_row(psy_audio_Machine* self)
{
	return (uintptr_t)(self->vtable->currbeatsperline(self) * 1.0 /
		self->vtable->beatspersample(self));
}

INLINE double psy_audio_machine_curr_lines_per_beat(psy_audio_Machine*
	self)
{
	return 1.0 / self->vtable->currbeatsperline(self);
}
...
INLINE bool psy_audio_machine_edit_resize(psy_audio_Machine* self,
	uintptr_t width, uintptr_t height)
{
	return self->vtable->editresize(self, width, height);
}

INLINE void psy_audio_machine_bus_changed(psy_audio_Machine* self)
{
...
INLINE bool psy_audio_machine_add_capture(psy_audio_Machine* self, int index)
{
	return self->vtable->addcapture(self, index);
}

INLINE bool psy_audio_machine_remove_capture(psy_audio_Machine* self, int index)
{
	return self->vtable->removecapture(self, index);
}

INLINE void psy_audio_machine_read_buffers(psy_audio_Machine* self, int index,
	float** pleft, float** pright, uintptr_t numsamples)
{
	self->vtable->readbuffers(self, index, pleft, pright, numsamples);
}

INLINE const char* psy_audio_machine_capture_name(psy_audio_Machine* self, int
	index)
{
	return self->vtable->capturename(self, index);
}

INLINE uintptr_t psy_audio_machine_num_captures(const psy_audio_Machine* self)
{
	return self->vtable->numcaptures(self);
}

INLINE const char* psy_audio_machine_playback_name(psy_audio_Machine* self, int
	index)
{
	return self->vtable->playbackname(self, index);
}

INLINE int psy_audio_machine_num_playbacks(psy_audio_Machine* self)
{
