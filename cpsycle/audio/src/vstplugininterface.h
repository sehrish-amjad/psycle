...
bool psy_audio_vstinterface_has_editor(const psy_audio_VstInterface*);
void psy_audio_vstinterface_open_editor(psy_audio_VstInterface*, void* handle);
void psy_audio_vstinterface_close_editor(psy_audio_VstInterface*);
void psy_audio_vstinterface_editor_idle(psy_audio_VstInterface*);
