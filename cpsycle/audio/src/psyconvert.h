...
typedef struct ModToVirtual {
	psy_Table table;
} ModToVirtual;

void modtovirtual_init(ModToVirtual*);
void modtovirtual_dispose(ModToVirtual*);

void modtovirtual_clear(ModToVirtual*);
void modtovirtual_set(ModToVirtual*, intptr_t mod,
	intptr_t virtual_inst);
intptr_t modtovirtual_at(const ModToVirtual*, intptr_t mod);
