...
/*!
** @struct psy_audio_PinConnection
** @brief Defines one pin connection inside a wire.
*/
...
** @brief Defines the pin connections inside a wire.
*/
...
psy_audio_WireSocket* psy_audio_connection_at(psy_audio_WireSockets*,
	uintptr_t slot);
uintptr_t psy_audio_connection_id(psy_audio_WireSockets* sockets,
	uintptr_t slot);

/*!
** @struct psy_audio_Wire
** @brief Adresses the wire between two machines.
*/
typedef struct psy_audio_Wire {
	uintptr_t src;
	uintptr_t src_id;
	uintptr_t dst;	
	uintptr_t dst_id;
...
/*!
** @struct psy_audio_Connections
** @brief Defines the wires between machines.
**
** @details
...
void psy_audio_connections_set_wire_volume(psy_audio_Connections*, psy_audio_Wire,
	double factor);
void psy_audio_connections_setpinmapping(psy_audio_Connections*, psy_audio_Wire,
	const psy_audio_PinMapping*);
double psy_audio_connections_wire_volume(const psy_audio_Connections*, psy_audio_Wire);
psy_audio_WireSocket* psy_audio_connections_input(psy_audio_Connections*,
	psy_audio_Wire);
const psy_audio_WireSocket* psy_audio_connections_input_const(
	const psy_audio_Connections*, psy_audio_Wire);
