...
/*! @struct psy_audio_MasterChannel */
...
typedef struct psy_audio_MasterChannel {
	...
	psy_audio_DoubleMachineParam dw_param;
	psy_audio_GainMachineParam gain_param;
	psy_audio_DoubleMachineParam pan_param;
...
typedef struct psy_audio_InputChannel {
	...
	psy_audio_DoubleMachineParam mix_param;
...
double inputchannel_wirevolume(const psy_audio_InputChannel*);
...
/*!
** @struct psy_audio_Mixer
** @brief Send Return Mixer and chain sheduling
**
** @details
** Psycle has two different mix
