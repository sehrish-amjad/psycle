...
void psy_ui_fontdialog_setfontinfo(psy_ui_FontDialog* self, psy_ui_FontInfo fontinfo)
{
	self->imp->vtable->dev_setfontinfo(self->imp, fontinfo);
}
...
static void dev_setfontinfo(psy_ui_FontDialogImp* self, psy_ui_FontInfo fontinfo) { }
...
static void imp_vtable_init(void)
{
	if (!imp_vtable_initialized) {
		...
		imp_vtable.dev_setfontinfo = dev_setfontinfo;
