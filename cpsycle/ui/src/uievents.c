...
{	
	...
	case psy_ui_KEY_OEM_1: return self->shift_key_ ? ':' : ';';
	case psy_ui_KEY_OEM_PLUS: return self->shift_key_ ? '+' : '=';
	case psy_ui_KEY_OEM_COMMA: return self->shift_key_ ? '<' : ',';
	case psy_ui_KEY_OEM_MINUS: return self->shift_key_ ? '_' : '-';
	case psy_ui_KEY_OEM_PERIOD: return self->shift_key_ ? '>' : '.';
	case psy_ui_KEY_OEM_2: return self->shift_key_ ? '?' : '/';
	case psy_ui_KEY_OEM_3: return self->shift_key_ ? '~' : '`';
	case psy_ui_KEY_OEM_4: return self->shift_key_ ? '{' : '[';
	case psy_ui_KEY_OEM_5: return self->shift_key_ ? '|' : '\\';
	case psy_ui_KEY_OEM_6: return self->shift_key_ ? '}' : ']';
	case psy_ui_KEY_OEM_7: return self->shift_key_ ? '\"' : '\'';	
	default:
		return 0;	
	}
}
