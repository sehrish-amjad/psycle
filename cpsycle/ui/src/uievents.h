...
INLINE bool psy_ui_keyboardevent_default_prevented(const psy_ui_KeyboardEvent* self)
{
	return psy_ui_event_default_prevented(&self->event);
}
...
INLINE bool psy_ui_keyboardevent_ctrl_key(const psy_ui_KeyboardEvent* self)
{
	return self->ctrl_key_;
}

/* returns TRUE if the Shift key was pressed down when the event occurred */
INLINE bool psy_ui_keyboardevent_shift_key(const psy_ui_KeyboardEvent* self)
{
