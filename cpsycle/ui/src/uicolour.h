...
INLINE psy_ui_Colour psy_ui_colour_make_rgba(uint8_t r, uint8_t g, uint8_t b,
	uint8_t a)
{
	psy_ui_Colour rv;
...
psy_ui_Colour* psy_ui_colour_add_rgb(psy_ui_Colour*, double r, double g,
	double b);
psy_ui_Colour* psy_ui_colour_mul_rgb(psy_ui_Colour*, double r, double g,
	double b);
...
INLINE psy_ui_Colour psy_ui_colour_overlayed(const psy_ui_Colour* self,
...
INLINE psy_ui_Colour psy_ui_colour_weighted(psy_ui_Colour self, int weight)
{	
