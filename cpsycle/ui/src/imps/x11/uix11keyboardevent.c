...
{	
	...
	case XK_Pause:
		return psy_ui_KEY_PAUSE;
	case XK_Insert:
    case XK_KP_Insert:
		return psy_ui_KEY_INSERT;			
	case XK_F1:
	...
	case XK_equal:
	case XK_plus:
		return psy_ui_KEY_OEM_PLUS;
	case XK_comma:
    case XK_less:
		return psy_ui_KEY_OEM_COMMA;	
	case XK_KP_Add:
		return psy_ui_KEY_ADD;		
	case XK_minus:
	case XK_underscore:
		return psy_ui_KEY_OEM_MINUS;
	case XK_KP_Multiply:
	...
	case XK_period:
	case XK_greater:
		return psy_ui_KEY_OEM_PERIOD;	
	case XK_question:
    case XK_slash:
		return psy_ui_KEY_OEM_2;	
	case XK_quoteleft:
	case XK_asciitilde:
		return psy_ui_KEY_OEM_3;
	case XK_colon:
    case XK_semicolon:
		return psy_ui_KEY_OEM_1;
	case XK_bracketleft:
    case XK_braceleft:
		return psy_ui_KEY_OEM_4;
	case XK_backslash:
	case XK_bar:
		return psy_ui_KEY_OEM_5;
	case XK_bracketright:
    case XK_braceright:
		return psy_ui_KEY_OEM_6;
	case XK_apostrophe:	
	case XK_quotedbl:
		return psy_ui_KEY_OEM_7;
	...
	Display* dpy, Window win, Window root)
{
    ...
    if (psy_ui_keyboardevent_shift_key(e) != FALSE) {
		rv.state |= ShiftMask;
	}
	if (psy_ui_keyboardevent_ctrl_key(e) != 0) {
