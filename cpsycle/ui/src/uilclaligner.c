...
static void psy_ui_lclaligner_align(psy_ui_LCLAligner*,
	psy_ui_Component* group);
static void psy_ui_lclaligner_preferred_size(psy_ui_LCLAligner*,
	psy_ui_Component* group,
	const psy_ui_Size* limit, psy_ui_Size* rv);
static void psy_ui_lclaligner_align_clients(psy_ui_LCLAligner*,
	psy_ui_Component* group, uintptr_t numclients, psy_List* children,
	psy_ui_RealPoint cp_topleft, psy_ui_RealPoint cp_bottomright);
static void psy_ui_lclaligner_resize_wrap_line(psy_ui_LCLAligner*,
	psy_List* wrap, double cpy, double cpymax);
				...
				psy_ui_component_set_position(curr,
					psy_ui_rectangle_make(
						...
						psy_ui_size_make_px(
							...
							height - psy_ui_margin_height_px(&c_margin, c_tm, &parentsize))));
