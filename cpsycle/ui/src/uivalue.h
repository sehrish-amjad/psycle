...
char* psy_ui_value_to_string(psy_ui_Value*, char* rv);	
...
INLINE bool psy_ui_value_is_zero(const psy_ui_Value* self)
{
	return (self->quantity == 0.0);
}

INLINE bool psy_ui_is_value_zero(psy_ui_Value value)
{
	return psy_ui_value_is_zero(&value);
}

INLINE bool psy_ui_value_is_set(const psy_ui_Value* self)
{
	return self->set;
}
