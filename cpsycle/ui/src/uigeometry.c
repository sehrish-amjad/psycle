...
void psy_ui_margin_set_top(psy_ui_Margin* self, psy_ui_Value value)
{
	self->top = value;
}

void psy_ui_margin_set_right(psy_ui_Margin* self, psy_ui_Value value)
{
	self->right = value;
}

void psy_ui_margin_set_bottom(psy_ui_Margin* self, psy_ui_Value value)
{
	self->bottom = value;
}

void psy_ui_margin_set_left(psy_ui_Margin* self, psy_ui_Value value)
{
	self->left = value;
}
