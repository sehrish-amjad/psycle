...
typedef struct psy_ui_ScreenImp* (*psy_ui_fp_impfactory_allocinit_screenimp)(struct psy_ui_ImpFactory*);
typedef struct psy_ui_ClipboardImp* (*psy_ui_fp_impfactory_allocinit_clipboardimp)(struct psy_ui_ImpFactory*);
...
typedef struct psy_ui_OpenDialogImp* (*psy_ui_fp_impfactory_allocinit_opendialogimp)(struct psy_ui_ImpFactory*, struct psy_ui_OpenDialog*, struct psy_ui_Component* parent);
typedef struct psy_ui_OpenDialogImp* (*psy_ui_fp_impfactory_allocinit_all_opendialogimp)(struct psy_ui_ImpFactory*, struct psy_ui_OpenDialog*, struct psy_ui_Component* parent,
	const char* title,
	const char* filter,
...
typedef struct psy_ui_ImpFactoryVTable {
	...
	psy_ui_fp_impfactory_allocinit_screenimp allocinit_screenimp;
	psy_ui_fp_impfactory_allocinit_clipboardimp allocinit_clipboardimp;
...
struct psy_ui_ScreenImp* psy_ui_impfactory_allocinit_screenimp(psy_ui_ImpFactory*);
struct psy_ui_ClipboardImp* psy_ui_impfactory_allocinit_clipboardimp(psy_ui_ImpFactory*);
...
struct psy_ui_OpenDialogImp* psy_ui_impfactory_allocinit_opendialogimp(psy_ui_ImpFactory*, struct psy_ui_OpenDialog* , struct psy_ui_Component* parent);
struct psy_ui_OpenDialogImp* psy_ui_impfactory_allocinit_all_opendialogimp(psy_ui_ImpFactory*, struct psy_ui_OpenDialog*, struct psy_ui_Component* parent,
	const char* title,
	const char* filter,
	const char* defaultextension,
	const char* initialdir);
