...
struct psy_ui_ScreenImp* psy_ui_impfactory_allocinit_screenimp(psy_ui_ImpFactory* self)
{
	return self->vtable->allocinit_screenimp(self);
}

struct psy_ui_ClipboardImp* psy_ui_impfactory_allocinit_clipboardimp(psy_ui_ImpFactory* self)
{
	return self->vtable->allocinit_clipboardimp(self);
}
...
struct psy_ui_ComponentImp* psy_ui_impfactory_allocinit_popupimp(psy_ui_ImpFactory* self, struct psy_ui_Component* component, struct psy_ui_Component* parent)
{
...
struct psy_ui_OpenDialogImp* psy_ui_impfactory_allocinit_opendialogimp(psy_ui_ImpFactory* self, struct psy_ui_OpenDialog* dlg,
	struct psy_ui_Component* parent)
{
	return self->vtable->allocinit_opendialogimp(self, dlg, parent);
}

struct psy_ui_OpenDialogImp* psy_ui_impfactory_allocinit_all_opendialogimp(psy_ui_ImpFactory* self, struct psy_ui_OpenDialog* dlg, struct psy_ui_Component* parent,
	const char* title,
	const char* filter,
	const char* defaultextension,
	const char* initialdir)
{
	return self->vtable->allocinit_all_opendialogimp(self, dlg, parent, title,
...
static struct psy_ui_ClipboardImp* allocinit_clipboardimp(psy_ui_ImpFactory* self) { return NULL; }
...
static struct psy_ui_ComponentImp* allocinit_popupimp(struct psy_ui_ImpFactory* self, struct psy_ui_Component* component, struct psy_ui_Component* parent) { return NULL; }
...
struct psy_ui_OpenDialogImp* allocinit_opendialogimp(psy_ui_ImpFactory* self, struct psy_ui_OpenDialog* dlg, struct psy_ui_Component* parent) { return NULL; }
struct psy_ui_OpenDialogImp* allocinit_all_opendialogimp(psy_ui_ImpFactory* self, struct psy_ui_OpenDialog* dlg, struct psy_ui_Component* parent,
	const char* title,
	const char* filter,
	const char* defaultextension,
	const char* initialdir)
...
static void vtable_init(void)
{
	if (!vtable_initialized) {
		...
		vtable.allocinit_clipboardimp = allocinit_clipboardimp;
