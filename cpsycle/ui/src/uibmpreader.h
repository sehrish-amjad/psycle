...
enum psy_ui_BmpEscape {
	psy_ui_BMPESCAPE_EOL = 0,   /* End of line */
	psy_ui_BMPESCAPE_EOB = 1,   /* End of bitmap */
	psy_ui_BMPESCAPE_DELTA = 2  /* Offset of the next pixel from the current
                                   position. */
};
