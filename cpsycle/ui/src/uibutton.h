...
extern "C" {
	...
	typedef struct psy_ui_ButtonRepeat {
	...
	/*!
	** @struct psy_ui_Button
	** @brief Displays a text field and/or a predefined Icon (psy_ui_ButtonIcon).
	**
	** @details
	...
	*/
	...
	void psy_ui_button_init_icon(psy_ui_Button*, psy_ui_Component* parent,
		psy_ui_ButtonIcon);
	void psy_ui_button_init_icon_connect(psy_ui_Button*, psy_ui_Component* parent,
		psy_ui_ButtonIcon, void* context, void* fp);

	psy_ui_Button* psy_ui_button_alloc(void);
	psy_ui_Button* psy_ui_button_allocinit(psy_ui_Component* parent);

	void psy_ui_button_connect(psy_ui_Button*, void* context, void* fp);
	void psy_ui_button_exchange(psy_ui_Button*, psy_Property*);
	...
	void psy_ui_button_set_line_spacing(psy_ui_Button*, double spacing);
	void psy_ui_button_set_text_alignment(psy_ui_Button*, psy_ui_Alignment);
	void psy_ui_button_prevent_translation(psy_ui_Button*);
	void psy_ui_button_set_click_mode(psy_ui_Button*, psy_ui_ClickMode mode);
	void psy_ui_button_set_repeat(psy_ui_Button*, uintptr_t rate,
		uintptr_t first_rate);
