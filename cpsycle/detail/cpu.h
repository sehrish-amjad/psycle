...
** modified version: disabled endian check to avoid boost
*/
...
#include "os.h"
	...
	*/
	...
	/* name extra instruction sets for x86 processors */
	/* { */
		/*
...
/* processor brand */
	...
	*/
	...
	#elif defined __arm__ /* arm64 not recognized (__ARM_ARCH (32 and 64 bit) instead __arm__ (which only is 32bits) ?) */
		#define DIVERSALIS__CPU
	...
	/* see http://msdn.microsoft.com/en-us/library/b0084kay.aspx */
		...
		#define DIVERSALIS__CPU
		#define DIVERSALIS__CPU__X86 64
		#define DIVERSALIS__CPU__X86__SSE 2 /* todo detect SSE3 */
		/* todo detect 3d-now */
		#define DIVERSALIS__CPU__X86__MMX
		...
		#define DIVERSALIS__CPU__X86 _M_IX86 / 100
			...
			*/
			/* todo detect SSE3 (prescott, nocona) */
...
/* consistency check */
	...
	/* todo: arm64 not recognized (__ARM_ARCH (32 and 64 bit) instead __arm__ (which only is 32bits) ?) */
	/* #error "unknown cpu" */
#endif
