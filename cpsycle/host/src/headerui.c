...
{			
	if (self->param) {
		...
		psy_ui_graphics_draw_solid_rectangle(g, r, psy_ui_style_background_colour(top_style));
		r = psy_ui_realrectangle_make(
			psy_ui_realpoint_make(0, half + quarter),
			psy_ui_realsize_make(size.width, quarter));
		psy_ui_graphics_draw_solid_rectangle(g, r, psy_ui_style_background_colour(bottom_style));
		...
		psy_ui_set_background_colour(g, psy_ui_style_background_colour(title_style));
		psy_ui_graphics_set_text_colour(g, psy_ui_style_colour(title_style));
		/* todo font_bold */
		psy_ui_graphics_textout_rectangle(g, psy_ui_realpoint_make(0, quarter),
