...
void styleviewbar_init(StyleViewBar* self, psy_ui_Component* parent)
{
	...
	psy_ui_button_init_text(&self->disk_op, &self->component, "DiskOp");	
}
	...
	psy_ui_Component* tabbarparent, Workspace* workspace)
{
	...
	psy_signal_connect(&self->bar.disk_op.signal_clicked, self,
		styleview_on_diskop);
}
