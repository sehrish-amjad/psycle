...
{		
	...
	psy_signal_connect(&self->resize.signal_mouse_down, self,
		trackbox_on_resize_mouse_down);
	psy_signal_connect(&self->resize.signal_mouse_move, self,
		trackbox_on_resize_mouse_move);
	psy_signal_connect(&self->resize.signal_mouse_up, self,
