...
{		
	...
	psy_ui_set_background_colour(g, psy_ui_style_background_colour(bottom_style));
	psy_ui_graphics_set_text_colour(g, psy_ui_style_colour(bottom_style));
	r = psy_ui_realrectangle_make(
		psy_ui_realpoint_make(0, half),
		psy_ui_realsize_make(size.width, half));
	psy_ui_graphics_textout_rectangle(g, psy_ui_realpoint_make(0, half),
