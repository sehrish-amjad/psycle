...
void virtualgeneratorbox_init(VirtualGeneratorsBox*, psy_ui_Component* parent,
	Workspace*);
void virtualgeneratorbox_update_samplers(VirtualGeneratorsBox*);
void virtualgeneratorbox_update_generators(VirtualGeneratorsBox*);
...
void instrumentheaderview_set_instrument(InstrumentHeaderView*,
