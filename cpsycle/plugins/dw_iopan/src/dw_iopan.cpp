...
void mi::Work(float *psamplesleft, float *psamplesright , int numsamples, int tracks)
{
	...
	{
		float lCoefR = Vals[LCHAN] / 128.f;								//how much of the LEFT channel goes to the RIGHT channel
		float lCoefL = 1.f - lCoefR;									//how much of the LEFT channel stays on the LEFT channel
		float rCoefR = Vals[RCHAN] / 128.f;								//how much of the RIGHT channel stays on the RIGHT channel
		float rCoefL = 1.f - rCoefR;									//how much of the RIGHT channel goes to the LEFT channel
