...
void Biquad::SetLowPass(double cosw, double sinw)
{
	...
	inCoeffs[0] = (float)((1.0 - cosw)/(2.0*a0));
	inCoeffs[1] = (float)((1.0 - cosw)/a0);
	inCoeffs[2] = (float)((1.0 - cosw)/(2.0*a0));

	outCoeffs[0] = (float)((-2.0*cosw)/a0);
	outCoeffs[1] = (float)((1.0 - alpha)/a0);
}
...
void Biquad::SetBandPassPeak(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)(q*alpha/a0);
	inCoeffs[1] = 0;
	inCoeffs[2] = (float)(-q*alpha/a0);
...
void Biquad::SetBandPass0dB(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)(alpha/a0);
	inCoeffs[1] = 0.0;
	inCoeffs[2] = (float)(-alpha/a0);
...
void Biquad::SetNotchBand(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)(1.0/a0);
	inCoeffs[1] = (float)((-2.0*cosw)/a0);
	inCoeffs[2] = (float)(1.0/a0);
...
void Biquad::SetAnalogPeakFilter(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)((1.0 - alpha)/a0);
	inCoeffs[1] = (float)((-2.0*cosw)/a0);
	inCoeffs[2] = (float)((1.0 - alpha)/a0);
...
void Biquad::SetPeakingEQ(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)((1.0 + alpha*A)/a0);
	inCoeffs[1] = (float)((-2.0*cosw)/a0);
	inCoeffs[2] = (float)((1.0 - alpha*A)/a0);

	outCoeffs[0] = (float)((-2.0*cosw)/a0);
	outCoeffs[1] = (float)((1.0 - alpha/A)/a0);
}
...
void Biquad::SetLowShelf(double cosw, double sinw, double w0)
{
	...
	inCoeffs[0] = (float)((A*( (A+1.0) - amonecos + beta *sinw ))/a0);
	inCoeffs[1] = (float)((2.0*A*( (A-1.0) - (A+1.0)*cosw) )/a0);
	inCoeffs[2] = (float)((A*( (A+1.0) - amonecos - beta *sinw ))/a0);

	outCoeffs[0] = (float)((-2.0*( (A-1.0) + (A+1.0)*cosw))/a0);
	outCoeffs[1] = (float)(((A+1) + amonecos - beta *sinw)/a0);
}
...
{
	inCoeffs[0] = (float)(b0/a0);
	inCoeffs[1] = (float)(b1/a0);
	inCoeffs[2] = (float)(b2/a0);

	outCoeffs[0] = (float)(a1/a0);
	outCoeffs[1] = (float)(a2/a0);
}