...
static float work(psy_dsp_SincResampler*,
	int16_t const* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length);
static float work_unchecked(psy_dsp_SincResampler*,
	const int16_t* data,
	uint32_t res);
...
float work(psy_dsp_SincResampler* self,
	int16_t const* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length)
...
float work_unchecked(psy_dsp_SincResampler* self,
	const int16_t* data,
	uint32_t res)
{
	sinc_data_t* t = (sinc_data_t*)(self->resampler_data);
