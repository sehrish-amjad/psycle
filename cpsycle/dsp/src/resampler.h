...
typedef float (*psy_dsp_fp_resampler_work)(struct psy_dsp_Resampler*,
	const int16_t* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length);
...
INLINE float psy_dsp_resampler_work(psy_dsp_Resampler* self,
	const int16_t* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length)
...
INLINE float psy_dsp_resampler_work_unchecked(psy_dsp_Resampler* self,
	const int16_t* data,
	uint32_t res,
	void* resampler_data)
{
