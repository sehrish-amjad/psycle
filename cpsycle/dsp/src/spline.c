...
static float work(psy_dsp_SplineResampler*,
	const int16_t* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length);
static float work_unchecked(psy_dsp_SplineResampler*,
	const int16_t* data,
	uint32_t res);
...
float work(psy_dsp_SplineResampler* self,
	const int16_t* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length)
...
float work_unchecked(psy_dsp_SplineResampler* self,
	const int16_t* data,	
	uint32_t res)
{
