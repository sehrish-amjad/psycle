...
static float work(psy_dsp_LinearResampler*,
	int16_t const* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length);
static float work_unchecked(psy_dsp_LinearResampler*,
	int16_t const* data,
	uint32_t res);
...
float work(psy_dsp_LinearResampler* self,
	int16_t const* data,
	uint64_t offset,
	uint32_t res,
	uint64_t length)
...
float work_unchecked(psy_dsp_LinearResampler* self,
	int16_t const* data,
	uint32_t res)
{
	const float y0 = (float)*data;
