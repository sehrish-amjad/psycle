...
AppID={{D2496E2D-A321-4481-99C8-75C1878C55A2}
AppName=Psycle Modular Music Creation Studio
AppVersion=1.12.5 beta
...
AppVerName=Psycle 1.12.5 beta 32 bits
...
[Files]
; Source: ..\msvc\output\win32\release\bin\boost_*.dll; DestDir: {app}; Flags: 64bit ignoreversion; Excludes: boost_unit_test_framework-*.dll; Components: Application; 
Source: ..\..\output\win32\release\bin\host.exe; DestDir: {app}; Flags: 64bit ignoreversion; Components: Application; 
; Source: ..\msvc\output\win32\release\bin\universalis.dll; DestDir: {app}; Flags: 64bit ignoreversion; Components: Application; 
Source: ..\..\output\win32\release\bin\audiodrivers\*.dll; DestDir: {app}\audiodrivers; Flags: 64bit ignoreversion; Excludes: sdl2.dll; Components: Application;
Source: ..\..\output\win32\release\bin\psycleplugins\*.dll; DestDir: {app}\PsyclePlugins; Flags: 64bit ignoreversion; Excludes: crasher.dll; Components: Open_Source_Plugins; 
...
[Icons]
Name: {group}\Psycle Modular Music Creation Studio; Filename: {app}\host.exe
...
Name: {commondesktop}\Psycle Modular Music Creation Studio; Filename: {app}\host.exe; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Psycle Modular Music Creation Studio; Filename: {app}\host.exe; Tasks: quicklaunchicon
...
Components: Winamp_plugin; Filename: "{tmp}\Psycle Winamp plugin_v1_12.exe"; WorkingDir: {tmp}; Flags: RunAsCurrentUser; 
