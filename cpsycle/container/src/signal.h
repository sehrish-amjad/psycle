...
** psy_signal_emit_double: variable number of generic double arguments
*/
...
void psy_signal_prevent_all(psy_Signal*);
...
void psy_signal_enable_all(psy_Signal*);
/* returns true if no slots are connected */
bool psy_signal_empty(const psy_Signal*);
...
*/
void psy_signal_emit_double(psy_Signal*, void* sender, intptr_t num, ...);
/*
** }
*/
